      ...
      <div className="container  pt-28 xl:pt-[5rem] lg:pt-[5rem] md:pt-[5rem]">
        ...
        >
          ...
          <h2 className="!text-[calc(1.4rem_+_1.5vw)] font-black !leading-[1.2] xl:!text-[2rem] text-[#343f52] tracking-tighter">
            {t(
              "hospital:hero.title",
              "ระบบ โรงพยาบาล ใช้งานง่าย ครบทุกฟังก์ชันในระบบเดียว",
            )}
          </h2>
          ...
          <div className="max-w-[850px] mx-auto">
            <p className="mt-0 text-[0.8rem] xl:text-[1rem] text-[#343f52] opacity-70">
              {t(
                ...
                "ระบบ โรงพยาบาล รองรับการจัดการ โรงพยาบาล พร้อม ระบบบริหารจัดการที่ครบวงจร ที่จะช่วยให้คุณทำงานได้อย่างมีประสิทธิภาพ รองรับหลากหลาย ทุกประเภท ทุกขนาด ทุกสาขา",
              )}
            </p>
          </div>
        </div>
