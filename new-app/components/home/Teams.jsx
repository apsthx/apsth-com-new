    ...
    >
      <div className="  pb-16 xl:pb-20 lg:pb-20 md:pb-20">
        <div
          ...
          data-delay={300}
          className="w-full flex-[0_0_auto] justify-center !px-0 !lg:px-[15px] max-w-full !text-center"
        >
          {/* 1. Headline: Monochrome Style - สีเดียวแต่เล่นระดับความหนา (Weight) */}
          <h2 className="!text-[calc(1.4rem_+_1.5vw)] !font-medium !leading-[1.2] xl:!text-[1.2rem] !mb-2 text-[#343f52] tracking-tighter">
            {t("home:teams.title", "ทีมงานของเรา")}
          </h2>

          {/* 2. Description: คุมโทนสีเทาเข้ม-จาง แบบเดียวกันทั้งหมด */}
          <div className="max-w-[850px] mx-auto">
            <p className="mt-0 text-[1rem] xl:text-[0.85rem] text-[#343f52]">
