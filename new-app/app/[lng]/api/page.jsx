...
export async function generateMetadata({ params }) {
  ...
  const page = {
    title: t("metadata:api.meta.title"),
    description: t("metadata:api.meta.description"),
    keywords: t("metadata:api.meta.keywords"),
    ogTitle: t("metadata:api.meta.og_title"),
    ogDesc: t("metadata:api.meta.og_description"),
    twTitle: t("metadata:api.meta.twitter_title"),
    twDesc: t("metadata:api.meta.twitter_description"),
  };
