...
export async function generateMetadata({ params }) {
  ...
  const page = {
    title: t("metadata:spa.meta.title"),
    description: t("metadata:spa.meta.description"),
    keywords: t("metadata:spa.meta.keywords"),
    ogTitle: t("metadata:spa.meta.og_title"),
    ogDesc: t("metadata:spa.meta.og_description"),
    twTitle: t("metadata:spa.meta.twitter_title"),
    twDesc: t("metadata:spa.meta.twitter_description"),
  };
