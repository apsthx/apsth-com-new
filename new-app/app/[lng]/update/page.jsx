...
import Update from "@/components/services/update/components/update";
...
export async function generateMetadata({ params }) {
  ...
  const page = {
    title: t("metadata:update.meta.title"),
    description: t("metadata:update.meta.description"),
    keywords: t("metadata:update.meta.keywords"),
    ogTitle: t("metadata:update.meta.og_title"),
    ogDesc: t("metadata:update.meta.og_description"),
    twTitle: t("metadata:update.meta.twitter_title"),
    twDesc: t("metadata:update.meta.twitter_description"),
  };
