...
import Hero from "@/components/services/hospital/components/Hero";
...
export async function generateMetadata({ params }) {
  ...
  const page = {
    title: t("metadata:hospital.meta.title"),
    description: t("metadata:hospital.meta.description"),
    keywords: t("metadata:hospital.meta.keywords"),
    ogTitle: t("metadata:hospital.meta.og_title"),
    ogDesc: t("metadata:hospital.meta.og_description"),
    twTitle: t("metadata:hospital.meta.twitter_title"),
    twDesc: t("metadata:hospital.meta.twitter_description"),
  };
