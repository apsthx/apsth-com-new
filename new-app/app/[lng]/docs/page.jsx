...
export async function generateMetadata({ params }) {
  ...
  const page = {
    title: t("metadata:docs.meta.title"),
    description: t("metadata:docs.meta.description"),
    keywords: t("metadata:docs.meta.keywords"),
    ogTitle: t("metadata:docs.meta.og_title"),
    ogDesc: t("metadata:docs.meta.og_description"),
    twTitle: t("metadata:docs.meta.twitter_title"),
    twDesc: t("metadata:docs.meta.twitter_description"),
  };
