...
export async function generateMetadata({ params }) {
  ...
  const page = {
    title: t("metadata:schedule_demo.meta.title"),
    description: t("metadata:schedule_demo.meta.description"),
    keywords: t("metadata:schedule_demo.meta.keywords"),
    ogTitle: t("metadata:schedule_demo.meta.og_title"),
    ogDesc: t("metadata:schedule_demo.meta.og_description"),
    twTitle: t("metadata:schedule_demo.meta.twitter_title"),
    twDesc: t("metadata:schedule_demo.meta.twitter_description"),
  };
