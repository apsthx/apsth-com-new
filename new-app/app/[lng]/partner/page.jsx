...
export async function generateMetadata({ params }) {
  ...
  const page = {
    title: t("metadata:partner.meta.title"),
    description: t("metadata:partner.meta.description"),
    keywords: t("metadata:partner.meta.keywords"),
    ogTitle: t("metadata:partner.meta.og_title"),
    ogDesc: t("metadata:partner.meta.og_description"),
    twTitle: t("metadata:partner.meta.twitter_title"),
    twDesc: t("metadata:partner.meta.twitter_description"),
  };
