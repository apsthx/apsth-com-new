...
import Hero from "@/components/services/wellness/components/Hero";
...
export async function generateMetadata({ params }) {
  ...
  const page = {
    title: t("metadata:wellness.meta.title"),
    description: t("metadata:wellness.meta.description"),
    keywords: t("metadata:wellness.meta.keywords"),
    ogTitle: t("metadata:wellness.meta.og_title"),
    ogDesc: t("metadata:wellness.meta.og_description"),
    twTitle: t("metadata:wellness.meta.twitter_title"),
    twDesc: t("metadata:wellness.meta.twitter_description"),
  };
...
export default async function WellnessPage({ params }) {
  const { lng } = await params;
  return (
    <>
